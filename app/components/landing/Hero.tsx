    ...
    <section className="grain-panel relative overflow-hidden rounded-3xl border border-(--line) p-5 sm:p-10 lg:p-11">
      ...
      <div className="relative grid gap-6 sm:gap-7 lg:grid-cols-[1.15fr_0.85fr] lg:items-end">
        <div>
          ...
          <div className="editorial-divider mt-6 rounded-2xl border border-(--line) bg-white/92 p-4 pt-5 shadow-[0_10px_30px_rgba(0,0,0,0.08)] sm:mt-8 sm:max-w-xl">
            <p className="text-[10px] font-bold uppercase tracking-[0.14em] text-(--muted) sm:text-[11px] sm:tracking-[0.16em]">
              Founder&apos;s note
            </p>
          ...
          <div className="mt-6 grid gap-2.5 sm:mt-8 sm:gap-3 sm:grid-cols-3">
            <div className="rounded-xl border border-(--line) bg-white/85 px-4 py-3">
              <p className="text-[11px] font-bold uppercase tracking-[0.14em] text-(--muted)">Options</p>
              <p className="mt-1 text-sm font-semibold text-(--ink)">100+ weekly meals</p>
            </div>
            <div className="rounded-xl border border-(--line) bg-white/85 px-4 py-3">
              <p className="text-[11px] font-bold uppercase tracking-[0.14em] text-(--muted)">Nutrition</p>
              <p className="mt-1 text-sm font-semibold text-(--ink)">Macro-balanced</p>
            </div>
            <div className="rounded-xl border border-(--line) bg-white/85 px-4 py-3">
              <p className="text-[11px] font-bold uppercase tracking-[0.14em] text-(--muted)">Flexibility</p>
        ...
        <div className="grid gap-2.5 sm:gap-3 sm:grid-cols-2 lg:grid-cols-1">
          <div className="rounded-xl border border-(--line) bg-[linear-gradient(160deg,rgba(255,255,255,0.96),rgba(228,248,253,0.96))] p-4 shadow-[0_12px_30px_rgba(0,0,0,0.08)]">
            ...
            <div className="mt-3 grid grid-cols-2 gap-2 text-[10px] font-bold uppercase tracking-[0.08em] sm:text-xs">
              <span className="rounded-md border border-(--line) bg-white px-2.5 py-2 text-center sm:px-3">Under 500</span>
              <span className="rounded-md border border-(--line) bg-white px-2.5 py-2 text-center sm:px-3">Gluten Free</span>
              <span className="rounded-md border border-(--line) bg-white px-2.5 py-2 text-center sm:px-3">Low Carb</span>
              <span className="rounded-md border border-(--line) bg-white px-2.5 py-2 text-center sm:px-3">High Protein</span>
            </div>
          </div>
          ...
          <div className="rounded-xl border border-(--line) bg-white p-4">
            ...
            <div className="mt-3 flex items-end gap-3">
              ...
              <p className="pb-1 text-sm font-semibold text-(--muted)">calories / meal</p>
            </div>
            <p className="mt-1 text-sm text-(--muted)">39g protein • 38g carbs • 20g fat</p>
          </div>
